...
void UI::process_keypress(sf::Event keypress) {
	...
	switch (keypress.key.code) {
		case sf::Keyboard::S: field.move_up(PLAYER1); break;
		case sf::Keyboard::W: field.move_down(PLAYER1); break;

		case sf::Keyboard::Down: field.move_up(PLAYER2); break;
		case sf::Keyboard::Up: field.move_down(PLAYER2); break;
